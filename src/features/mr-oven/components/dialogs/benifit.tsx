...
const BenefitFocusedDialog = ({ onClose }) => {
  const steps = [
    {
      title: 'Hook',
      description: 'A benefits-focused, compelling opening statement or question designed to grab the viewer\'s attention immediately.'
    },
    {
      title: 'Product Intro',
    ...
    {
      title: 'Benefit',
      description: 'Reinforcing the key advantages and positive outcomes of using the product.'
    },
    {
      title: 'Demo',
    ...
    {
      title: 'Summary of Solution',
      description: 'Summarizing how the product solves the problem.'
    },
    {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Benefit-Focused</h2>
...
export default BenefitFocusedDialog;