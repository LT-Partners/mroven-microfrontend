...
const ProductDifferentiationDialog = ({ onClose }) => {
  const steps = [
    {
      title: 'Hook',
      description: 'A compelling opening statement or question that sets the product apart, designed to grab the viewer\'s attention immediately.'
    },
    {
      title: 'Problem',
      description: 'A description of the issue or pain point the target audience is experiencing.'
    },
    {
      title: 'Failed Solution',
      description: 'Describing other solutions that have failed to solve the problem effectively.'
    },
    {
      title: 'Product Intro',
    ...
    {
      title: 'Features/USP',
      description: 'Describing the unique features or unique selling propositions (USPs) of the product.'
    },
    {
      title: 'Demo',
    ...
    },
    {
      ...
      description: 'Describing the ideal outcome the user can expect from using the product.'
    },
    {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Product Differentiation</h2>
...
export default ProductDifferentiationDialog;