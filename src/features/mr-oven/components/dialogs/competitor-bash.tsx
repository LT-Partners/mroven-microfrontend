...
const CompetitorBashingDialog = ({ onClose }) => {
  const steps = [
    {
      title: 'Hook',
      description: 'A compelling opening statement or question designed to grab the viewer\'s attention immediately that mentions a competitors\' product.'
    },
    {
      title: 'Problem',
    ...
    },
    {
      ...
      description: 'Highlighting specific features and the benefits they provide.'
    },
    {
      title: 'Bad Alternative',
      description: 'Criticizing other solutions or products that don\'t solve the problem effectively.'
    },
    {
      title: 'Results',
      description: 'Showing the positive outcomes of using your product.'
    },
    {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Competitor Bashing</h2>
...
export default CompetitorBashingDialog;